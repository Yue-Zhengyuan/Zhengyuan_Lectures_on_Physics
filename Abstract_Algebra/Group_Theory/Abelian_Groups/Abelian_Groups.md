...
The most familiar cyclic groups are $\mathbb{Z}$ (under addition) and $\mathbb{Z}_N$ (under addition modulo $N$). In fact, all cyclic groups are isomorphic to them.
...
- Finite cyclic groups generated by one order-$N$ generator are isomorphic to $\mathbb{Z}_N$.
...
A finitely generated abelian group can also be related to the cyclic groups $\mathbb{Z}, \mathbb{Z}_n$ by the following theorem.
