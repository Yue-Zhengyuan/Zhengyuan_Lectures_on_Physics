...
for i, basis in enumerate(bases):
    ...
    if i == 0:
        ...
        ax.text(*(basis[0] - 0.4*basis[1]), r'$e_1^\prime$', **text_kw, color='red', alpha=alpha)
        ax.text(*(basis[1] - 0.4*basis[0]), r'$e_2^\prime$', **text_kw, color='blue', alpha=alpha)
...
plt.show()
fig.savefig(dir_path + '/scale_2d.svg')
